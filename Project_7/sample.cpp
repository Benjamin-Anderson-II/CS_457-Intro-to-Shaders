...
Display( )
{
    ...
    float twist = 0.33 * sin(Time * F_2_PI);

    Pattern.SetUniformVariable((char *) "uUseChromaKey", NowChromaKey);
    Pattern.SetUniformVariable((char *) "uRedDepth", 1);
    Pattern.SetUniformVariable((char *) "uBlueDepth", 4.4);
    Pattern.SetUniformVariable((char *) "uTwist", twist);
    Pattern.SetUniformVariable((char *) "uDist", NowDistance);
    Pattern.SetUniformVariable((char *) "uTol",  NowTolerance);
    Pattern.SetUniformVariable((char *) "uP",    NowP);
	glCallList( DinoList );
