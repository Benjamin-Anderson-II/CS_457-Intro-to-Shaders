...
Display( )
{
    ...
    Pattern.SetUniformVariable( (char *)"uA" , NowAmplitude);
    Pattern.SetUniformVariable( (char *)"uP" , NowPeriod);
...
InitGraphics( )
{
	...
	Pattern.Use( );
    Pattern.SetUniformVariable((char *)"uA", 0.05);
    Pattern.SetUniformVariable((char *)"uP", 0.5);
	Pattern.SetUniformVariable( (char *)"uKa", 0.1f );
	Pattern.SetUniformVariable( (char *)"uKd", 0.5f );
	Pattern.SetUniformVariable( (char *)"uKs", 0.4f );
	Pattern.SetUniformVariable( (char *)"uColor", 1.f, 0.6f, 0.f, 1.f );
