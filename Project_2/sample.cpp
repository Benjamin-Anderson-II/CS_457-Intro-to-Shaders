...
float NowAd, NowBd, NowTol, NoiseFreq, NoiseAmp;
int NowSmooth;
GLuint Noise3;
GLSLProgram Pattern;
...
Display( )
{
    ...
    Pattern.SetUniformVariable( (char *)"uSmooth", NowSmooth );
...
InitGraphics( )
{
	...
	Pattern.SetUniformVariable( (char *)"uColor", 1.f, 1.f, 1.f, 1.f );
